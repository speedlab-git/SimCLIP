...
--vizwiz_train_questions_json_path /c/CodesSpring24/SimCLIP/eval_benchmark/vizwiz/train_questions_vqa_format.json \
--vizwiz_train_annotations_json_path /c/CodesSpring24/SimCLIP/eval_benchmark/vizwiz/train_annotations_vqa_format.json \
--vizwiz_test_questions_json_path /c/CodesSpring24/SimCLIP/eval_benchmark/vizwiz/val_questions_vqa_format.json \
--vizwiz_test_annotations_json_path /c/CodesSpring24/SimCLIP/eval_benchmark/vizwiz/val_annotations_vqa_format.json
